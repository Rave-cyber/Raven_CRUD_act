...
<body style="background-image: url('go.png'); background-size: cover; background-position: center; background-repeat: no-repeat; min-height: 100vh; margin: 0;">

    <div class="container">
        <h1 class="my-4 text-center">Flower Shop</h1>
